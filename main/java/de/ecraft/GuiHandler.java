...
import de.ecraft.gui.GuiStirlingEngine;
...
public class GuiHandler implements IGuiHandler {
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world,
		...
		switch(id) {
			...
			case 2:return new GuiStirlingEngine(player.inventory, (TileEntityStirlingEngine)world.getTileEntity(new BlockPos(x, y, z)));
			default: return null;
		}
	}
	...
	public Object getServerGuiElement(int id, EntityPlayer player, World world,
		...
		switch(id) {
			...
			case 2: return new ContainerStirlingEngine((TileEntityStirlingEngine)world.getTileEntity(new BlockPos(x, y, z)), player.inventory);
		default: return null;
		}
	}
