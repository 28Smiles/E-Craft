...
public class ConfigHandler {
	...
	public static int advanced_steam_processing;
	...
	public void init() {
		...
		advanced_steam_processing       = config.getInt("advanced_steam_processing"      , category_energy_general, 4, 0, 16, "Enable avanced steam processing mode(More realistic)");
